...
import { registerCashCountRoutes } from './cash-count-routes.ts';
import { registerCashReconRoutes } from './cash-recon-routes.ts';
import { registerClosingRoutes } from './closing-routes.ts';
...
registerDashboardRoutes(app, prisma, getAuthenticatedUser);
...
registerCashCountRoutes(app, prisma, getAuthenticatedUser);
registerCashReconRoutes(app, prisma, getAuthenticatedUser);
registerClosingRoutes(app, prisma, getAuthenticatedUser);
registerAuditRoutes(app, prisma, getAuthenticatedUser);
registerPnlRoutes(app, prisma, getAuthenticatedUser);
registerReportsRoutes(app, prisma, getAuthenticatedUser);
registerStockReconRoutes(app, prisma, getAuthenticatedUser);
